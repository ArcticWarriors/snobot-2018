...
public class SnobotADXRS450_Gyro extends GyroBase implements Gyro, PIDSource, Sendable {
   ...
   */
  public SnobotADXRS450_Gyro(SPI.Port port) {
    m_spi = new SPI(port);
